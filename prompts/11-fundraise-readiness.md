...
3. The non-dilutive option most worth pursuing right now
```
...
**Step 1's undocumented-equity check is the one that blocks deals.** Close those before you start, not during diligence. [`worksheets/advisor-scope.md`](../worksheets/advisor-scope.md).
